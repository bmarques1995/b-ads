	...
	_lastLocation(InvalidDropArea)
{
	...
	areaWidgets.insert(B_ADS_NS::TopDropArea, createDropIndicatorWidget(TopDropArea)); //createDropWidget(":/img/split-top.png"));
	areaWidgets.insert(B_ADS_NS::RightDropArea, createDropIndicatorWidget(RightDropArea));//createDropWidget(":/img/split-right.png"));
	areaWidgets.insert(B_ADS_NS::BottomDropArea, createDropIndicatorWidget(BottomDropArea));//createDropWidget(":/img/split-bottom.png"));
	areaWidgets.insert(B_ADS_NS::LeftDropArea, createDropIndicatorWidget(LeftDropArea));//createDropWidget(":/img/split-left.png"));
	areaWidgets.insert(B_ADS_NS::CenterDropArea, createDropIndicatorWidget(CenterDropArea));//createDropWidget(":/img/dock-center.png"));
...
void DropOverlay::paintEvent(QPaintEvent*)
{
	...
	switch (da)
	{
	case B_ADS_NS::TopDropArea:
		r.setHeight(r.height() / 2);
		break;
	case B_ADS_NS::RightDropArea:
		r.setX(r.width() / 2);
		break;
	case B_ADS_NS::BottomDropArea:
		r.setY(r.height() / 2);
		break;
	case B_ADS_NS::LeftDropArea:
		r.setWidth(r.width() / 2);
		break;
	case B_ADS_NS::CenterDropArea:
		r = rect();
		break;
	default:
		r = QRect();
...
void DropOverlayCross::reset()
{
	...
	allAreas << B_ADS_NS::TopDropArea << B_ADS_NS::RightDropArea << B_ADS_NS::BottomDropArea << B_ADS_NS::LeftDropArea << B_ADS_NS::CenterDropArea;
