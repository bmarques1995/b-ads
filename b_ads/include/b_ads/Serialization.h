...
class B_ADS_EXPORT_API HeaderEntity
{
public:
	static qint32 MAGIC;
...
class B_ADS_EXPORT_API OffsetsHeaderEntity
{
public:
	OffsetsHeaderEntity();
...
class B_ADS_EXPORT_API OffsetsHeaderEntryEntity
{
public:
...
class B_ADS_EXPORT_API SectionEntity
{
public:
	SectionEntity();
	qint32 x;
...
class B_ADS_EXPORT_API SectionContentEntity
{
public:
...
class B_ADS_EXPORT_API FloatingContentEntity
{
public:
...
class B_ADS_EXPORT_API HierarchyData
{
public:
	HierarchyData();
	QByteArray data;
...
class B_ADS_EXPORT_API SectionIndexData
{
public:
	SectionIndexData();
 ...
 */
class B_ADS_EXPORT_API InMemoryWriter
{
public:
	InMemoryWriter();
 ...
 */
class B_ADS_EXPORT_API InMemoryReader
{
public:
